-e # Default configuration file for tmux-powerline.
# Modeline {
...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/dt/l3qw2m7n1496kdfyh2qs3h2r0000gp/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/SIEGELCH/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/SIEGELCH/.mailcheckrc"
# }
